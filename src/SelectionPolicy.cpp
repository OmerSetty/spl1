...
virtual const FacilityType& NaiveSelection::selectFacility(const vector<FacilityType>& facilitiesOptions) {
    int currentIndex = lastSelectedIndex; 
    lastSelectedIndex++;
    return facilitiesOptions[currentIndex];
}

virtual const string NaiveSelection:: toString() const {
    return "Naive Selction";
}

virtual NaiveSelection* NaiveSelection::clone() {
    return this;
}
// // TODO
// virtual NaiveSelection::~NaiveSelection() {}

virtual int distanceCalculator (int lifeQualityScore, int economyScore, int environmentScore) {
...
virtual BalancedSelection::BalancedSelection(int currLifeQualityScore, int currEconomyScore, int currEnvironmentScore) :
    LifeQualityScore(currLifeQualityScore), EconomyScore(currEconomyScore), EnvironmentScore(currEnvironmentScore) {}

virtual const FacilityType& BalancedSelection::selectFacility(const vector<FacilityType>& facilitiesOptions) {
    int min = INT_MAX;
    int index = 0;
...
virtual const string BalancedSelection:: toString() const {
...
virtual const FacilityType& EconomySelection::selectFacility(const vector<FacilityType>& facilitiesOptions) {
...
virtual const string EconomySelection::toString() const {
...
virtual const FacilityType& SustainabilitySelection::selectFacility(const vector<FacilityType>& facilitiesOptions) {
...
// TODO? (Not in assignment)
virtual const string SustainabilitySelection::toString() const {
    return "Sustainability Selection";
}

virtual SustainabilitySelection* SustainabilitySelection::clone() {
    return this;
}
// // TODO
